...
(1,	1,	2,	'riud',	'ru',	'',	1,	'*',	'',	'all.mail',	'vhost',	0,	'name',	'/var/www/clients/client1/web1',	'',	'web1',	'client1',	-1,	-1,	'n',	'n',	'y',	1,	1,	'none',	'php-fpm',	'n',	'n',	'n',	'',	'',	'',	'n',	'n',	'n',	'n',	'',	'',	'',	'',	'AF',	'all.mail',	'',	'',	'',	'',	'',	NULL,	'awstats',	'All',	'',	'',	'y',	'dynamic',	10,	2,	1,	5,	10,	0,	'/var/www/clients/client1/web1/web:/var/www/clients/client1/web1/private:/var/www/clients/client1/web1/tmp:/var/www/all.mail/web:/srv/www/all.mail/web:/usr/share/php5:/usr/share/php:/tmp:/usr/share/phpmyadmin:/etc/phpmyadmin:/var/lib/phpmyadmin:/dev/random:/dev/urandom',	'',	'none',	1,	'',	'y',	'n',	'',	'',	'n',	NULL,	'',	'2019-05-12',	'admin',	0,	'n',	80,	443,	NULL,	10);
